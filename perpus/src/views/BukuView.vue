      ...
      <TableBody>
        <TableRow v-for="(item, index) in books" :key="item.isbn">
          ...
          <TableCell class="text-right">
            ...
            <Button variant="outline" size="sm" @click="delete_dialog(item.isbn)">
    ...
    <AlertDialog :open="showDeleteDialog" @update:open="showDeleteDialog = $event">
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription> This action cannot be undone. This will permanently delete the book and remove its data from our servers. </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
